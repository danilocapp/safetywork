...
module.exports = async ({ id }) => {
    const record = await loginService.findUserById(id)
    return `
    <!-- Main Container -->
      ...
      <div class="bg-image" style="background-image: url('assets/media/photos/photo10@2x.jpg');">
        <div class="bg-primary-dark-op">
          <div class="content content-full text-center">
            ...
            <h1 class="h2 text-white mb-0">Modifica account</h1>
            <h2 class="h4 fw-normal text-white-75">
              John Parker
            </h2>
            <a class="btn btn-alt-secondary" href="/profile">
              <i class="fa fa-fw fa-arrow-left text-danger"></i> Torna al profilo
            </a>
          </div>
        </div>
      </div>
